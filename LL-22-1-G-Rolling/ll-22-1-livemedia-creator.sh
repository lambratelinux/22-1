...
sudo livemedia-creator --ks /home/idraulico/LambrateLinux-devel/LL-22-1-G-Rolling/ll-live-workstation.ks \
--tmp /home/idraulico/LambrateLinux-devel/LL-22-1-G-Rolling/tmp \
--resultdir /home/idraulico/LambrateLinux-devel/LL-22-1-G-Rolling/lmc \
--project LL-22-1-G-Rolling-Live --make-iso --volid LL-22-1-G-Rolling-Live --iso-only --iso-name LL-22-1-G-Rolling-Live.iso --releasever 36 --macboot --no-virt
