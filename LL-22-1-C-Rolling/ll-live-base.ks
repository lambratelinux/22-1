...
# Progetto: Lambrate Linux Workstation (Rolling)
...
# Lambrate Linux è una derivata di Fedora che usa i repositories di Fedora 
# Commentare e decommentare in modo corretto
# a scelta tra RAWHIDE (un repo) e NOT-RAWHIDE (3 repo)

#NOT RAWHIDE (3 repo di cui 1 commentato "testing")
...
### Installa tutto quel che vuoi dal repo locale (rpmLLrepoRolling)
### Posizionare i pacchetti da installare in ll-xxxxxx-common.ks

repo --name=rpmLLrepoRolling --baseurl=file:///home/idraulico/rpmLLrepoRolling/
...
#RPMFUSION-NOT RAWHIDE (2+2 repo)
...
#RPMFUSION-RAWHIDE (2 repo)
repo --name=rpmfusion-free-rawhide --mirrorlist=https://mirrors.rpmfusion.org/metalink?repo=free-fedora-rawhide&arch=$basearch
repo --name=rpmfusion-nonfree-rawhide --mirrorlist=https://mirrors.rpmfusion.org/metalink?repo=nonfree-fedora-rawhide&arch=$basearch

#GOOGLE-CHROME (1 repo)
