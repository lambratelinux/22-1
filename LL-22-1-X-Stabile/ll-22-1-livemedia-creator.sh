...
sudo livemedia-creator --ks /home/idraulico/LambrateLinux-devel/LL-22-1-X-Stabile/ll-live-xfce.ks \
--tmp /home/idraulico/LambrateLinux-devel/LL-22-1-X-Stabile/tmp \
--resultdir /home/idraulico/LambrateLinux-devel/LL-22-1-X-Stabile/lmc \
--project LL-22-1-X-Stabile-Live --make-iso --volid LL-22-1-X-Stabile-Live --iso-only --iso-name LL-22-1-X-Stabile-Live.iso --releasever 35 --macboot --no-virt
